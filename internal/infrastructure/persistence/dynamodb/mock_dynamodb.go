...
// MockDynamoDBClient はDynamoDBClientインターフェースのモック実装です
type MockDynamoDBClient struct {
	mock.Mock
}

// GetItem はGetItemメソッドのモック実装です
...
// DeleteItem はDeleteItemメソッドのモック実装です
...
// BatchWriteItem はBatchWriteItemメソッドのモック実装です
...
// TransactWriteItems はTransactWriteItemsメソッドのモック実装です
